            ...
            steps
            {
                ...
                )
                {
                    script
                    {
                        ...
                        sh "cd ./checkout/_site && rsync --rsh=\"ssh ${verbose} ${sshOptions}\" -az --delete --exclude \".well-known\" ./_site ${ACTIVITYPUB_USER}@activitypub.shendrick.net:activitypub.shendrick.net";
                    }
                }
            }
        }
